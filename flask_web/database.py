...
def insertar_cita(id, medico, paciente, hora, fecha, motivo):
    cursor = database.cursor()
    cursor.execute("INSERT INTO citas (id, medico, paciente, hora, fecha, motivo) VALUES (%s, %s, %s, %s, %s, %s)",(id, medico, paciente, hora, fecha, motivo))
    database.commit()
